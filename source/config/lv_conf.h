...
#if LV_TICK_CUSTOM
    #define LV_TICK_CUSTOM_INCLUDE "ch.h"         /*Header for the system time function*/
    #define LV_TICK_CUSTOM_SYS_TIME_EXPR (TIME_I2MS(chVTGetSystemTime()))    /*Expression evaluating to current system time in ms*/
